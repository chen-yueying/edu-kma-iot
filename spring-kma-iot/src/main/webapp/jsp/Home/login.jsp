...
<tiles:insertDefinition name="re-login">
	<tiles:putAttribute name="body">
		<div class="container-fluid login">
			<div class="container re-login">
				<form  method="post" action="/check_sec" autocomplete="on">
					<input type="hidden" name="${_csrf.parameterName}"
						value="${_csrf.token}">
					<c:if test="${not empty error}">
						<p style="color: red; text-align: center;">Số điện thoại hoặc mật
							khẩu không đúng !</p>
					</c:if>
					...
					<span>Đăng nhập bằng: <a style="vertical-align: -7px;" href=""><i class="fa fa-facebook-official" style="font-size:30px;color:#0067CA;"></i></a></span>
					<span style="float: right;"><a href="/register">Đăng ký</a></span>
				</form>
			</div>
		</div>
